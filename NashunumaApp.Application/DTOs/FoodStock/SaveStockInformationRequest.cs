// Application/DTOs/Stock/SaveStockInformationRequest.cs
namespace NashunumaApp.Application.DTOs.Stock
{
    public class SaveStockInformationRequest
    {
...
// Application/DTOs/Stock/MissingStockDateDto.cs
namespace NashunumaApp.Application.DTOs.Stock
{
    public class MissingStockDateDto
    {
...
// Application/DTOs/Stock/MissingStockNotificationDto.cs
namespace NashunumaApp.Application.DTOs.Stock
{
    public class MissingStockNotificationDto
    {
        public string SiteId { get; set; }
